...
class Color:
    ...
    REPO_CLEAN_BG = 47 #41 #148  # a light green color
    REPO_CLEAN_FG = 0  # black
    REPO_DIRTY_BG = 9 # 161  # pink/red
...
class Powerline:
    ...
    def __init__(self, mode='default', reverse=False):
        if reverse:
            self.separator = Powerline.symbols[mode]['separator_left']
        else:
...
if __name__ == '__main__':
    ...
    p = Powerline(mode=args.m, reverse=args.r)
    cwd = get_valid_cwd()
    if(args.r):
