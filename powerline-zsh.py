...
class Color:
    ...
    # SEPARATOR_FG = 254 # nearly-white grey

    # REPO_CLEAN_BG = 39 # light blue
    ...
    # CMD_FAILED_BG = 161 # deep pin
    # CMD_FAILED_FG = 15 # white

    # SVN_CHANGES_BG = 33 # dark light blue 
    # SVN_CHANGES_FG = 27 # medium light blue

    # VIRTUAL_ENV_BG = 39 # lightest blue
    # VIRTUAL_ENV_FG = 45 # lighter than lightest blue ;)

    #j-monokai theme
    PATH_BG = 237  # dark grey
    PATH_FG = 33 # light blue
    CWD_FG = 48  # light green
    SEPARATOR_FG = 254 # nearly-white grey
    ...
    CMD_PASSED_BG = 236 # dark grey
    CMD_PASSED_FG = 228 # yellow

    CMD_FAILED_BG = 161 # pink/red
    CMD_FAILED_FG = 15 # white
